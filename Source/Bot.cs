...
namespace WinBot
{
    class Bot
    {
        ...
        void VerifyIntegrity()
        {
            ...
            string resourcesJson = webClient.DownloadString("https://raw.githubusercontent.com/floppyNET/covfefe/master/Resources/resources.json");
            ...
            foreach(string resource in resources) {
                if(!ResourceExists(resource, ResourceType.Resource)) {
                    webClient.DownloadFile($"https://raw.githubusercontent.com/floppyNET/covfefe/master/Resources/{resource}", GetResourcePath(resource, ResourceType.Resource));
